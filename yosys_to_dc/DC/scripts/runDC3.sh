...
outFolder="$workingFolder/outs_combined_S"
...
dc_shell-xg-t -64bit -f $workingFolder/scripts/synth_DC3.tcl | tee $outFolder/$termianlOutFile
...
mv $cellFile $outFolder/$cellFile
#remove extra files
